...
\f0\fs24 \cf0 import \{ GDCRequirement \} from '../types';\
\
export const GDC_REQUIREMENTS: GDCRequirement[] = [\
  ...
  \{\
    id: 1,\
    standard: 1,\
    title: "Pre-clinical Competency Assessment",\
  ...
  \{\
    ...
    evidenceExamples: [\
      "Relevant policy and procedures",\
      "Records and content of supervisor training and induction",\
  ...
  \{\
    ...
    evidenceExamples: [\
      "Relevant policy and procedures",\
      "Student and staff training regarding candour",\
  ...
  \{\
    ...
    evidenceExamples: [\
      ...
      "Reporting systems for serious untoward incidents"\
    ]\
  \},\
  \{\
    id: 8,\
  ...
  \},\
  \
  // Standard 2: Quality Evaluation and Review\
  \{\
    id: 9,\
    standard: 2,\
    title: "Quality Management Framework",\
    description: "The provider must have a framework in place that details how it manages the quality of the programme which includes making appropriate changes to ensure the curriculum continues to map across to the latest GDC outcomes.",\
    evidenceExamples: [\
      "Relevant policy, procedures and documentation",\
      "Review policy and timeline",\
      "Use of multisource feedback",\
  ...
  \{\
    ...
    description: "Any concerns identified through the operation of the quality management framework, including internal and external reports relating to quality, must be addressed as soon as possible and the GDC notified of serious threats.",\
    evidenceExamples: [\
      "Relevant policy and procedures including escalation process",\
      "Whistleblowing policy",\
      "Minutes from committee(s) responsible for programme review",\
  ...
  \{\
    ...
    evidenceExamples: [\
      "Relevant policy and procedures",\
      "Information on external review bodies",\
      "External examiner details and reports",\
      "Patient/customer feedback methods"\
    ]\
  \},\
  \{\
    id: 12,\
    ...
    evidenceExamples: [\
      "Relevant policy and procedures for placements",\
      "Feedback from staff, patients and students",\
      "Audit reports",\
      "Monitoring reports from placement providers"\
    ]\
  \},\
  \
  ...
  \{\
    id: 13,\
    standard: 3,\
    title: "Learning Outcome Attainment",\
    ...
    evidenceExamples: [\
      ...
      "Student progression statistics",\
      "Blueprint demonstrating links between assessments and learning outcomes"\
    ]\
  \},\
  \{\
    id: 14,\
    ...
    evidenceExamples: [\
      ...
      "Records of student clinical and/or technical experience"\
    ]\
  \},\
  \{\
    id: 15,\
    ...
    description: "Students must have exposure to an appropriate breadth of patients and procedures and should undertake each activity relating to patient care on sufficient occasions to enable them to develop the skills and competency.",\
    evidenceExamples: [\
      "Relevant policy and procedures",\
  ...
  \{\
    ...
    evidenceExamples: [\
      ...
      "Remit and minutes of responsible groups",\
  ...
  \{\
    id: 18,\
    standard: 3,\
    title: "Student Support and Feedback",\
  ...
  \{\
    ...
    evidenceExamples: [\
      "List of assessors/examiners showing qualifications",\
      "Evidence of training specific to assessment",\
      "Recruitment and appointment policy",\
      "Assessor calibration and recalibration training"\
    ]\
  \},\
  \{\
    id: 20,\
  ...
  \{\
    ...
    description: "Assessment must be fair and undertaken against clear criteria. The standard expected of students in each area must be clear and an appropriate standard setting process must be employed for summative assessments.",\
    evidenceExamples: [\
...
\
export const GDC_STANDARDS = \{\
  1: \{\
    name: "Protecting Patients",\
    description: "Providers must be aware of their duty to protect the public. Providers must ensure that patient safety is paramount and care of patients is of an appropriate standard."\
  \},\
  2: \{\
    name: "Quality Evaluation and Review",\
  ...
  3: \{\
    ...
    description: "Assessment must be reliable and valid. The choice of assessment method must be appropriate to demonstrate achievement of the GDC learning outcomes."\
  \}\
\};}